...
public class CustomerAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.mCustomerDetail = (TextView) convertView
					.findViewById(R.id.list_customer_detail_tv);
		...
		holder.mNameTv.setText(mDatas.get(position).getId());
		holder.mPhoneTv.setText(mDatas.get(position).getId());
		holder.mCustomerDetail.setText(mDatas.get(position).getId());
	...
	static class ViewHolder {
		...
		public TextView mCustomerDetail;
